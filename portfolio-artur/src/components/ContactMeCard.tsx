    ...
    return (
      <div className="flex-1 mx-12" onClick={handleCardClick}>
        <CardContainer className="w-full cursor-pointer">
          <CardBody className="bg-none flex justify-center items-center relative rounded-xl h-40">
            <CardItem
              translateZ="100"
              className="text-xl font-bold text-neutral-600 dark:text-white"
            >
              <div className="image-container flex justify-center items-center"></div>
            </CardItem>
          </CardBody>
        </CardContainer>
      </div>
